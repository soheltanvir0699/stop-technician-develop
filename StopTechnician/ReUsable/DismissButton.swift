...
public class DismissButton: UIButton {
    ...
    override public var isHighlighted: Bool { didSet { setNeedsDisplay() } }
    override public var isSelected: Bool { didSet { setNeedsDisplay() } }
