...
public class CountdownLabel: LTMorphingLabel {
    ...
    public convenience init(frame: CGRect, fromDate: NSDate, targetDate: Date) {
        self.init(frame: frame)
    ...
    public func setCountDownDate(targetDate: Date) {
        setCountDownDate(fromDate: Date() as NSDate, targetDate: targetDate)
    }
    
    public func setCountDownDate(fromDate: NSDate, targetDate: Date) {
        self.fromDate = fromDate
