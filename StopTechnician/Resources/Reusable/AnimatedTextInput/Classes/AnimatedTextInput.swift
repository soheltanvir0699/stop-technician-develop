...
//
    ...
    fileprivate func addPlaceHolder() {
        ...
        if GusLanguage.shared.currentLang == "ar" {
            placeholderLayer.string = arabicTranslation
        } else {
            placeholderLayer.string = defaultTranslation
        }
    ...
    fileprivate func configurePlaceholderAsActiveHint() {
        ...
        var textPlaceholder = ""
        if GusLanguage.shared.currentLang == "ar" {
            textPlaceholder = arabicTranslation
        } else {
            textPlaceholder = defaultTranslation
        }
